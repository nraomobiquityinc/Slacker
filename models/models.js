...
var actionSchema = new Schema({
    ...
    data: {
        ...
        command: {
            ...
            pipe: {type: Boolean, required: true},
            redirects: {type: Boolean, required: true},
            redirectTo: [{type: String}],
        },
        pipedResponse: {type: String}
    }
});
...
var userSchema = new Schema({
    ...
    teamDomain: {type: String, required: true},
    teamID: {type: String, required: true},
    queuedActions: [{type: Schema.Types.ObjectId, ref: 'Action'}]
});
